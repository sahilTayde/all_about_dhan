...
def build_founder_status() -> dict[str, Any]:
    ...
    return {
        ...
        "ml_paper": {
            ...
            "book_rank": ml.get("book_rank") or [],
            "today": ml.get("today") or {},
            "index_notes": ml.get("index_notes") or [],
            "overall_pnl_inr": ml.get("overall_pnl_inr"),
            "overall_gross_pnl_inr": ml.get("overall_gross_pnl_inr"),
            "overall_charges_inr": ml.get("overall_charges_inr"),
            "win_rate_net_pct": ml.get("win_rate_net_pct", ml.get("win_rate_pct")),
            "win_rate_gross_pct": ml.get("win_rate_gross_pct"),
            "capital_plan": ml.get("capital_plan") or {},

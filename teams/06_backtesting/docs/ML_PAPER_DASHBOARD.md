...
| 5 | `MIX-ML-LOGIT` | ML | 0 | 0 | 0 | 0 | None | None | None | None | 0.0 | 0.0 |
| 6 | `MIX-ML-LOGIT-XR` | ML | 0 | 0 | 0 | 0 | None | None | None | None | 0.0 | 0.0 |
...
| `MIX-DEFAULT-BUY` | NIFTY | CE | 23200.0 | 218.3 | 228.8 | 228.3 | 205.202 | `TARGET` | True | 16145.78 | SUCCESS | TREND | 2026-09-21T11:56:23+05:30 |
| `MIX-DEFAULT-BUY` | NIFTY | CE | 23200.0 | 211.8 | 213.2 | 221.8 | 199.092 | `CANCEL_STALL` | False | 1411.51 | STALL | TREND | 2026-09-21T11:51:39+05:30 |
| `MIX-DEFAULT-BUY` | NIFTY | CE | 23200.0 | 204.05 | 208.1 | 214.05 | 191.807 | `CANCEL_STALL` | False | 5739.23 | STALL | TREND | 2026-09-21T11:25:42+05:30 |
| `MIX-DEFAULT-BUY` | NIFTY | CE | 23200.0 | 196.0 | 200.4 | 210.7 | 184.24 | `CANCEL_STALL` | False | 6337.75 | STALL | TREND | 2026-09-21T10:56:30+05:30 |
...
- `MIX-DEFAULT-BUY` NIFTY CE SUCCESS `TARGET`: NIFTY buy CE ITM strike 23200.0 (ITM_100); bin=CE regime=TREND/UP last3=none; impulse_note=pause_expired; path stop 205.202 → target 228.3 (premium points; strict first TARGET; T2 parked); overlay=CE+PE+strength; need_strength: last-3 / pause_continue / SHORT_COVER / itm_bin confirm / TREND ER≥0.35 same wing; why_now=CE: rally / CE bin / CE short-cover (not PE-locked); PAPER only. NO_PROMOTE. Groww+STT on fill. | CLOSE: EXIT TARGET; result=SUCCESS; status=CLOSED_PAPER; P/L net ₹16145.78; strict first TARGET booked; T2 parked; target_hit=true
- `MIX-DEFAULT-BUY` NIFTY CE STALL `CANCEL_STALL`: NIFTY buy CE ITM strike 23200.0 (ITM_100); bin=CE regime=TREND/UP last3=none; impulse_note=wait_pause_after_impulse; path stop 199.092 → target 221.8 (premium points; strict first TARGET; T2 parked); overlay=CE+PE+strength; need_strength: last-3 / pause_continue / SHORT_COVER / itm_bin confirm / TREND ER≥0.35 same wing; why_now=CE: rally / CE bin / CE short-cover (not PE-locked); PAPER only. NO_PROMOTE. Groww+STT on fill. | CLOSE: EXIT CANCEL_STALL; result=STALL; status=CLOSED_CANCEL; P/L net ₹1411.51; filled cancel still books round-trip Groww+STT; target_hit=false
- `MIX-DEFAULT-BUY` NIFTY CE STALL `CANCEL_STALL`: NIFTY buy CE ITM strike 23200.0 (ITM_100); bin=CE regime=TREND/UP last3=none; impulse_note=no_raw_impulse; path stop 191.807 → target 214.05 (premium points; strict first TARGET; T2 parked); overlay=CE+PE+strength; need_strength: last-3 / pause_continue / SHORT_COVER / itm_bin confirm / TREND ER≥0.35 same wing; why_now=CE: rally / CE bin / CE short-cover (not PE-locked); PAPER only. NO_PROMOTE. Groww+STT on fill. | CLOSE: EXIT CANCEL_STALL; result=STALL; status=CLOSED_CANCEL; P/L net ₹5739.23; filled cancel still books round-trip Groww+STT; target_hit=false
- `MIX-DEFAULT-BUY` NIFTY CE STALL `CANCEL_STALL`: NIFTY buy CE ITM strike 23200.0 (ITM_100); bin=CE regime=TREND/UP last3=none; path stop 184.24 → target 210.7 (premium points; strict first TARGET; T2 parked); overlay=CE+PE+strength; need_strength: last-3 / pause_continue / SHORT_COVER / itm_bin confirm / TREND ER≥0.35 same wing; why_now=CE: rally / CE bin / CE short-cover (not PE-locked); PAPER only. NO_PROMOTE. Groww+STT on fill. | CLOSE: EXIT CANCEL_STALL; result=STALL; status=CLOSED_CANCEL; P/L net ₹6337.75; filled cancel still books round-trip Groww+STT; target_hit=false
...
- DATA_INSUFFICIENT: NIFTY ATM days ['2026-09-17', '2026-09-18', '2026-09-21'] have no INDEX 1m (merged INDEX span 2021-09-06→2026-09-16)
- DATA_INSUFFICIENT: BANKNIFTY ATM days ['2026-09-17', '2026-09-18', '2026-09-21'] have no INDEX 1m (merged INDEX span 2021-09-06→2026-09-16)
- DATA_INSUFFICIENT: SENSEX ATM days ['2026-09-17', '2026-09-18', '2026-09-21'] have no INDEX 1m (merged INDEX span 2021-09-06→2026-09-16)

...
Skills: each team `SKILL.md` is an operational playbook (duties, inputs, outputs, quality bar, books/training). Founder trace: [`FOUNDER_REQUIREMENTS_TRACE.md`](docs/FOUNDER_REQUIREMENTS_TRACE.md). Competitive baseline: [`COMPETITIVE_PRODUCT_BASELINE.md`](docs/COMPETITIVE_PRODUCT_BASELINE.md). Dual-model counsel: [`COUNSEL_LLM.md`](teams/00_orchestrator/docs/COUNSEL_LLM.md). Fast path has **zero blocking LLM calls**; live LLM counsel is async risk review on compact facts.
...
| 01 | Research | YouTube catalog + transcripts (channels from `config/workspace.yaml`; default `@DhanHQ`); **research-analyst** (`TOPIC_COVERAGE` KNOWN vs DI); **Research Boss** (after-hours club → `MIX-*` HYPOTHESIS; 00 still default ticket) | `teams/01_research/` · prompt [`RESEARCH_BOSS_SKILL.md`](teams/00_orchestrator/docs/RESEARCH_BOSS_SKILL.md) |
...
| **Company departments / bosses** | [`docs/COMPANY_DEPARTMENTS.md`](docs/COMPANY_DEPARTMENTS.md), [`docs/FOUNDER_REQUIREMENTS_TRACE.md`](docs/FOUNDER_REQUIREMENTS_TRACE.md), [`docs/COMPETITIVE_PRODUCT_BASELINE.md`](docs/COMPETITIVE_PRODUCT_BASELINE.md), [`docs/PRODUCT_ARCHITECTURE_STANDARDS.md`](docs/PRODUCT_ARCHITECTURE_STANDARDS.md), team `SKILL.md`, PM [`FOUNDER_PM.md`](teams/00_orchestrator/docs/FOUNDER_PM.md), dealer [`FRONT_DESK.md`](teams/05_analysis/docs/FRONT_DESK.md) |
...
| **Research Boss (00 invoke)** | Standing prompt [`RESEARCH_BOSS_SKILL.md`](teams/00_orchestrator/docs/RESEARCH_BOSS_SKILL.md); 01 [`SKILL.md`](teams/01_research/SKILL.md) Hats A/C/B; coverage [`TOPIC_COVERAGE.md`](teams/01_research/docs/TOPIC_COVERAGE.md); 01 loop + 00 transition [`RESEARCH_BOSS_LOOP.md`](teams/00_orchestrator/docs/RESEARCH_BOSS_LOOP.md). After hours only. 00 keeps `/` default. |
...
| Resume / new chat | [`CONTINUE_NEXT_CHAT.md`](teams/00_orchestrator/docs/CONTINUE_NEXT_CHAT.md) then [`FILE_CREATION.md`](docs/FILE_CREATION.md) — do not glob markdown; do not restart npm until asked |

...
## 22. TradingView Editors’ Picks strategies (`MIX-TV-EP-*`) — WEB-DERIVED / TV-EDITOR-PICK
...
NO_PROMOTE: true
pine_copied: false
docs: refernece_tradingview/editors_picks/INDEX.md
```

| MIX | TV title (author) | Notes for 06 |
|-----|-------------------|--------------|
| MIX-TV-EP-001 | TASC 2026.08 An Ag Selling Model (PineCodersTASC) | short-lean commodity harvest model |
| MIX-TV-EP-002 | TASC 2026.03 One Percent A Week (PineCodersTASC) | long; few named inputs |
| MIX-TV-EP-003 | Trading Report Generator from CSV (adolgov) | infra / CSV report — not an entry recipe |
| MIX-TV-EP-004 | TrendMaster Pro 2.3 with Alerts (everget) | MA/HTF template; many inputs |
| MIX-TV-EP-005 | Bjorgum Double Tap (Bjorgum) | long+short pattern template |
| MIX-TV-EP-006 | Traling.SL.Target (Sharad_Gaikwad) | trailing SL/TP helper |
| MIX-TV-EP-007 | Template Trailing Strategy (Backtester) (jason5480) | mega-template; do not essay |
| MIX-TV-EP-008 | 3Commas Bot (Bjorgum) | webhook/bot template |
| MIX-TV-EP-009 | Monthly Returns in PineScript Strategies (QuantNomad) | reporting overlay |
| MIX-TV-EP-010 | How to use Leverage and Margin in PineScript (Peter_O) | education / leverage demo |
| MIX-TV-EP-011 | Сalculation a position size based on risk (adolgov) | sizing example |
| MIX-TV-EP-012 | Oscillator Evaluator (mks17) | analysis tool |
| MIX-TV-EP-013 | Built-in Kelly ratio (CryptoRox) | sizing overlay |
| MIX-TV-EP-014 | Ultimate Strategy Template (Daveatt) | template |
| MIX-TV-EP-015 | Stop loss and Take Profit in $$ example (adolgov) | SL/TP dollars example |
| MIX-TV-EP-016 | Stepped trailing strategy example (adolgov) | trailing example |
| MIX-TV-EP-017 | PMax Explorer STRATEGY & SCREENER (KivancOzbilgic) | PMax ATR trail family |
| MIX-TV-EP-018 | Grid Like Strategy (alexgrover) | grid / size path |
| MIX-TV-EP-019 | Gap Filling Strategy (alexgrover) | gap fill |
| MIX-TV-EP-020 | inwCoin Martingale Strategy for Bitcoin (Real_inwCoin) | BTC martingale — not NSE default |
| MIX-TV-EP-021 | LUBE (Jomy) | friction/range research script |
| MIX-TV-EP-022 | How To Set Backtest Time Ranges (allanster) | date-range + MA demo |
| MIX-TV-EP-023 | Grover Llorens Activator Strategy Analysis (alexgrover) | activator analysis |
| MIX-TV-EP-024 | Factory SMA crossover (PROJECT) | **not** an Editors’ Pick card — 06 `sma_cross` calibrator |
| MIX-TV-EP-025 | Factory MACD hist (PROJECT) | **not** an Editors’ Pick card — 06 `macd_hist` calibrator |

Next new **listing** pine = `MIX-TV-EP-026`.

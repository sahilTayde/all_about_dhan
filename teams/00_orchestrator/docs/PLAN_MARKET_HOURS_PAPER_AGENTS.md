...
**Council:** verdict `APPROVE_WITH_GUARDRAILS` (session dump deleted; see this plan + runbook).  
**Paper path:** runbook [`PAPER_MARKET_HOURS_RUNBOOK.md`](PAPER_MARKET_HOURS_RUNBOOK.md)  

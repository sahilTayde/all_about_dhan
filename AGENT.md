...
| 01 | Research | YouTube catalog + transcripts (channels from `config/workspace.yaml`; default `@DhanHQ`); **Research Boss** (after-hours club → `MIX-*` HYPOTHESIS; 00 still default ticket) | `teams/01_research/` · prompt [`RESEARCH_BOSS_SKILL.md`](teams/00_orchestrator/docs/RESEARCH_BOSS_SKILL.md) |
...
| **Research Boss (00 invoke)** | Standing prompt [`RESEARCH_BOSS_SKILL.md`](teams/00_orchestrator/docs/RESEARCH_BOSS_SKILL.md); 01 [`SKILL.md`](teams/01_research/SKILL.md) Hat B; loop [`RESEARCH_BOSS_LOOP.md`](teams/01_research/docs/RESEARCH_BOSS_LOOP.md); club [`CLUB_SEVEN_BOOKS.md`](teams/01_research/docs/book_reads/CLUB_SEVEN_BOOKS.md). After hours only. 00 keeps `/` default. |
